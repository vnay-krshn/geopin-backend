...
class ReactFlagsSelect extends Component {
	...
	onSelect(countryCode) {
        ...
        let countryInfo={
            ...
            country_icon:require(`./flags/${countryCode.toLowerCase()}.svg`)
        }
        
		this.props.onSelect && this.props.onSelect(countryInfo);
	}
...
// countryCode:countryCode,
// country:countries[countryCode],
// country_icon:`./flags/${countryCode.toLowerCase()}.svg`
